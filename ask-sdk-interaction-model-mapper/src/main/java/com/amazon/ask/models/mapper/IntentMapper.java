...
import com.amazon.ask.models.mapper.intent.*;
...
public class IntentMapper {
    private static final Map<ClassKey, com.amazon.ask.models.mapper.intent.IntentPropertyReader> DEFAULT_INTENT_PROPERTY_READERS = new HashMap<>();
    static {
    ...
    private static final Map<ClassKey, com.amazon.ask.models.mapper.slot.SlotPropertyReader> DEFAULT_SLOT_PROPERTY_READERS = new HashMap<>();
    static {
    ...
    private final Map<ClassKey, com.amazon.ask.models.mapper.slot.SlotPropertyReader> slotReaderCache;

    private final Map<ClassKey, com.amazon.ask.models.mapper.intent.IntentPropertyReader> intentPropertyReaders;
    private final Map<ClassKey, com.amazon.ask.models.mapper.slot.SlotPropertyReader> slotPropertyReaders;

    protected IntentMapper(Model model, Map<ClassKey, com.amazon.ask.models.mapper.intent.IntentPropertyReader> intentPropertyReaders, Map<ClassKey, com.amazon.ask.models.mapper.slot.SlotPropertyReader> slotPropertyReaders) {
    ...
    public <T> IntentReader<T> intentReaderFor(JavaType type) {
        return (IntentReader<T>) intentReaderCache.computeIfAbsent(type, k -> {
            ...
            for (PropertyDescriptor prop : reflector.getPropertyDescriptors()) {
                ...
                com.amazon.ask.models.annotation.data.IntentPropertyReader intentPropertyReader = reflector.getAnnotation(prop, com.amazon.ask.models.annotation.data.IntentPropertyReader.class);
                if (intentPropertyReader == null) {
                    intentPropertyReader = Utils.findAnnotation(propertyType, com.amazon.ask.models.annotation.data.IntentPropertyReader.class);
                }
                if (intentPropertyReader != null) {
                ...
                if (slotProperty != null) {
                    ...
                    if (reader == null) {
                        com.amazon.ask.models.mapper.slot.SlotPropertyReader slotPropertyReader;
                        com.amazon.ask.models.annotation.data.SlotPropertyReader alexaSlotPropertyReader = reflector.getAnnotation(prop, com.amazon.ask.models.annotation.data.SlotPropertyReader.class);
    ...
    public <T> com.amazon.ask.models.mapper.slot.SlotPropertyReader slotReaderFor(Class<T> slotClass) {
        return this.slotReaderCache.computeIfAbsent(new ClassKey(slotClass), k -> {
            com.amazon.ask.models.annotation.data.SlotPropertyReader slotPropertyReader = Utils.findAnnotation(slotClass, com.amazon.ask.models.annotation.data.SlotPropertyReader.class);
            ...
            Map<String, com.amazon.ask.models.mapper.slot.SlotPropertyReader> readers = new HashMap<>();
    ...
    protected com.amazon.ask.models.mapper.slot.SlotPropertyReader resolveSlotPropertyReader(TypeReflector<?> slotTypeReflector, PropertyDescriptor slotProperty) {
        ...
        com.amazon.ask.models.mapper.slot.SlotPropertyReader reader;
        com.amazon.ask.models.annotation.data.SlotPropertyReader attribute = slotTypeReflector.getAnnotation(slotProperty, com.amazon.ask.models.annotation.data.SlotPropertyReader.class);
        if (attribute == null) {
            attribute = Utils.findAnnotation(propertyType, com.amazon.ask.models.annotation.data.SlotPropertyReader.class);
        }
        if (attribute != null) {
        ...
        if (reader == null) {
            throw new IllegalArgumentException(String.format("Could not resolve a %s for %s", com.amazon.ask.models.mapper.slot.SlotPropertyReader.class.getName(), propertyType.getName()));
        }
    ...
    public static final class Builder {
        private Model model;
        private Map<ClassKey, com.amazon.ask.models.mapper.intent.IntentPropertyReader> intentPropertyReaders = new HashMap<>();
        private Map<ClassKey, com.amazon.ask.models.mapper.slot.SlotPropertyReader> slotPropertyReaders = new HashMap<>();
        ...
        public Builder withIntentPropertyReaders(Map<ClassKey, com.amazon.ask.models.mapper.intent.IntentPropertyReader> intentPropertyReaders) {
            this.intentPropertyReaders = intentPropertyReaders;
            return this;
        }

        public Builder addIntentPropertyReaders(Map<ClassKey, com.amazon.ask.models.mapper.intent.IntentPropertyReader> intentPropertyReaders) {
            intentPropertyReaders.forEach(this::addIntentPropertyReader);
            return this;
        }

        public Builder addIntentPropertyReader(ClassKey classKey, com.amazon.ask.models.mapper.intent.IntentPropertyReader intentPropertyReader) {
        ...
        public Builder withSlotPropertyReaders(Map<ClassKey, com.amazon.ask.models.mapper.slot.SlotPropertyReader> slotPropertyReaders) {
            this.slotPropertyReaders = slotPropertyReaders;
            return this;
        }

        public Builder addSlotPropertyReaders(Map<ClassKey, com.amazon.ask.models.mapper.slot.SlotPropertyReader> slotPropertyReaders) {
            slotPropertyReaders.forEach(this::addSlotPropertyReader);
            return this;
        }

        public Builder addSlotPropertyReader(ClassKey classKey, com.amazon.ask.models.mapper.slot.SlotPropertyReader slotPropertyReader) {
