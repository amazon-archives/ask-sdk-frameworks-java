...
package com.amazon.ask.decisiontree.slots;
...
@SlotType("salaryImportanceType")
@SlotTypeResource("salary_importance_type_slot")
public class SalaryImportanceTypeSlot extends BaseSlotValue {
}